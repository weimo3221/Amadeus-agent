...
- 已实现 verified manifest policy 的第一版 runtime-level enforcement，以及 action-specific approval key 的默认过期；仍需补更清晰的 approval UI 文案、可配置 expiry、更多 action classifier、file-resume override 语义和工作区沙箱策略。
