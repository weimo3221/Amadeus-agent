...
- 仍需补更细的危险/敏感/低置信度动作 approval policy、workspace sandbox policy、真正工具/文件状态级续跑的 resume policy，以及真正 isolated child runtime。
...
- 仍需实现工具/文件状态级真正续跑的进程 resume/restart 策略，以及更细的 approval checkpoint policy 和工作区沙箱策略。
