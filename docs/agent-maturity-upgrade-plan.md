...
- 已实现 verified manifest policy 的第一版 runtime-level enforcement；仍需补更细的 approval checkpoint policy、file-resume override 语义和工作区沙箱策略。
