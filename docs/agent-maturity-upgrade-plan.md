...
- 已实现 verified manifest policy 的第一版 runtime-level enforcement、action-specific approval key 的可配置过期、以及 task-detail approval action/risk/expiry 展示；仍需补更清晰的 inline approve/resume 文案、更多 action classifier、file-resume override 语义和工作区沙箱策略。
