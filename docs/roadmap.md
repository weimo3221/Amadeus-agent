...
- External durable multi-process task supervisor, multi-child graph orchestration quality, richer OS-native sandbox backends beyond the current copy/env/guard layer, and broader approval/override policy tuning.
