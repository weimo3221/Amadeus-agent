...
- External durable multi-process task supervisor, policy-driven skip/guardrail decisions from verified manifests, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
