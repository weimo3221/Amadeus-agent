...
- External durable multi-process task supervisor, stronger policy coverage for risky worker actions, more granular file-resume overrides, and truly isolated child-runtime workspace sandboxing.
