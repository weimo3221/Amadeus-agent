...
- External durable multi-process task supervisor tool/state-level continuation from saved phases plus truly isolated child-runtime human approval checkpoints and workspace sandboxing.
