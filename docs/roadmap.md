...
- External durable multi-process task supervisor, stronger file hash/manifest-based continuation from saved phases, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
