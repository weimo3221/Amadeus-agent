...
- Multi-child graph orchestration quality, richer OS-native sandbox backends beyond the current copy/env/guard layer, longer supervisor/worker double-crash soak coverage, and broader approval/override policy tuning.
