...
- External durable multi-process task supervisor richer restart/checkpoint policy plus truly isolated child-runtime permission prompts and workspace sandboxing.
