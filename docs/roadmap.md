...
- External durable multi-process task supervisor, tool/state-level continuation from saved phases, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
