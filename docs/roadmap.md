...
- External durable multi-process task supervisor richer restart/checkpoint policy plus truly isolated child-runtime human approval checkpoints and workspace sandboxing.
