...
- External durable multi-process task supervisor, automatic verify/skip decisions from saved file manifests, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
