...
- External durable multi-process task supervisor true continuation from saved phases plus truly isolated child-runtime human approval checkpoints and workspace sandboxing.
