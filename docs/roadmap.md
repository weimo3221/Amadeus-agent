...
- External durable multi-process task supervisor, stronger policy coverage for risky worker actions, user-facing file-resume override operations, and truly isolated child-runtime workspace sandboxing.
