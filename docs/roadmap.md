...
- External durable multi-process task supervisor true resume/restart policy plus truly isolated child-runtime human approval checkpoints and workspace sandboxing.
