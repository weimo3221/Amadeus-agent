...
- External durable multi-process task supervisor, stronger classifiers for risky worker actions, more granular file-resume overrides, and truly isolated child-runtime workspace sandboxing.
