...
- External durable multi-process task supervisor, runtime-level enforcement/UI exposure for verified manifest policies, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
