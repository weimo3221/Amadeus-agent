...
- External durable multi-process task supervisor, real file-state/idempotent tool continuation from saved phases, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
