...
- External durable multi-process task supervisor richer restart policy, explicit attempt-abandonment handling, and worker-profile policy enforcement.
