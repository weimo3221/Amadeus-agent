...
- External durable multi-process task supervisor, real tool/file-state continuation from saved phases, richer approval checkpoint policy/UI for risky worker actions, and truly isolated child-runtime workspace sandboxing.
