...
- External durable multi-process task supervisor, richer approval checkpoint policy/UI for risky worker actions, more granular file-resume overrides, and truly isolated child-runtime workspace sandboxing.
