...
- Memory review safety filters now block secret-like content and temporary debug/run state before candidates are persisted.
...
- Next: broaden memory safety filters for uncertain claims, scope classification, and overly specific local paths.
