...
- `memory.py`: active SQLite-backed message history, roles/sessions, structured memory, task state, task events, task plan runs, scheduled messages, persistent todos, and audit records.
