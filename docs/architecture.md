...
- Mature long-running execution beyond the current single-host SQLite-leased supervisor with OS-native sandbox backends, longer double-crash/restart soak coverage, resource-usage telemetry, and richer user-facing notification policy.
